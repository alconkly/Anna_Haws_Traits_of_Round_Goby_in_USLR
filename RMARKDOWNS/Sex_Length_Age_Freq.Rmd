...
RG_dissected <- read_excel("G:/Dissertation/Chapter 4- VHSV demographic/Anna_Haws_Traits_of_Round_Goby_in_USLR/Data/DISSECTED.xlsx") 
...
RG_notdissected<-read_excel("G:/Dissertation/Chapter 4- VHSV demographic/Anna_Haws_Traits_of_Round_Goby_in_USLR/Data/NOT_DISSECTED.xlsx") 
...
ggsave("Length_Histogram.tiff", device="tiff", plot=CombinedHist, path="G:/POP_STRUCTURE_PUB/Figures/Resized_TIFFs", dpi="retina", width = 90, height = 90, units="mm")
...
ggsave("Age_Histogram.tiff", device="tiff", plot=Age_Histogram, path="G:/POP_STRUCTURE_PUB/Figures/Resized_TIFFs", dpi="retina", width = 90, height = 90, units="mm")
```
