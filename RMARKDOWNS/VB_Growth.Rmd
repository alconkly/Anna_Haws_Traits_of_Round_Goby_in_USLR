...
VBPlot %>% ggsave(filename="VBPlot.tiff", device = "tiff", path="~/GitHub/Anna_Haws_Traits_of_Round_Goby_in_USLR/Figures/TIFFs", dpi="retina", width = 190, height = 100, units="mm")
