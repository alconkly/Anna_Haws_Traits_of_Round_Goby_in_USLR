...
Maturity_Plot %>% ggsave(filename="Maturity_Plot.tiff", device = "tiff", path="G:/POP_STRUCTURE_PUB/Figures/Resized_TIFFs", dpi="retina", width = 190, height = 100, units="mm")
...
ggsave("GSI_LINE.tiff", device="tiff", plot=GSI_LINE, path="G:/POP_STRUCTURE_PUB/Figures/Resized_TIFFs", dpi="retina", width = 90, height = 90, units = "mm")
