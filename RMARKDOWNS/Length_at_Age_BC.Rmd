...
ggsave("OR_TL.tiff", device="tiff", plot=ORTL, path="~/GitHub/Anna_Haws_Traits_of_Round_Goby_in_USLR/Figures/TIFFs", dpi="retina", width = 190, height = 100, units="mm")
```
...
RG_BC_jitter %>% ggsave(filename="BC_jitter.tiff", device = "tiff", path="~/GitHub/Anna_Haws_Traits_of_Round_Goby_in_USLR/Figures/TIFFs", dpi="retina", width = 190, height = 100, units="mm")
